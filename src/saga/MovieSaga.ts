import {all, takeLatest, spawn, put} from 'redux-saga/effects';
import MovieActions, {MovieTypes} from '../reduxs/reducer/MovieReducer';

function* getMovies() {
  console.log('get movies');

  yield put(MovieActions.getMoviesSuccess(fakeData));
}

export default function* rootSaga() {
  const sagas: any[] = [takeLatest(MovieTypes.GET_MOVIES, getMovies)];
